...
public class Pharmacy {
    ...
    String wgs84Lat;
    String wgs84Lon;
    boolean isOpenInNight;
    boolean isOpenInHoliday;
    boolean isOpenInSaturday;
    boolean isOpenInSunday;
    ...
    public boolean isOpenInNight() {
        return isOpenInNight;
    }

    public void setOpenInNight(boolean openInNight) {
        isOpenInNight = openInNight;
    }

    public boolean isOpenInHoliday() {
        return isOpenInHoliday;
    }

    public void setOpenInHoliday(boolean openInHoliday) {
        isOpenInHoliday = openInHoliday;
    }

    public boolean isOpenInSaturday() {
        return isOpenInSaturday;
    }

    public void setOpenInSaturday(boolean openInSaturday) {
        isOpenInSaturday = openInSaturday;
    }

    public boolean isOpenInSunday() {
        return isOpenInSunday;
    }

    public void setOpenInSunday(boolean openInSunday) {
        isOpenInSunday = openInSunday;
    }
}
